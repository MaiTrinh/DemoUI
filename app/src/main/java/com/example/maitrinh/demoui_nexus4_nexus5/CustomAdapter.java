...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.CustomViewHolder> {
    ...
    public List<WashService> serviceList = new ArrayList<>();
    public LayoutInflater layoutInflater;

    public CustomAdapter (Context context, List<WashService> serviceList){
    ...
    public void onBindViewHolder(CustomViewHolder holder, int position) {
        if(serviceList.get(position).isColor()){
            ...
            holder.tvPrice.setText((serviceList.get(position).getPrice()));
        }else{
            holder.tvName.setText(serviceList.get(position).getName());
            holder.tvPrice.setText((serviceList.get(position).getPrice()));
        }
